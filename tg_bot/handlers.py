...
CONSTRUCTOR_START, CHOOSING_CLASS, CHOOSING_RACE, CHOOSING_CHARACTERISTICS, CHOOSING_SKILLS, CHOOSING_WEAPON, CHOOSING_AGE, CHOOSING_STORY, CHOOSING_NAME, CHOOSING_GENDER = range(10)
